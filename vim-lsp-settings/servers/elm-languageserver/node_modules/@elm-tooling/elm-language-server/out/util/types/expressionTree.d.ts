...
declare type Pattern = EPattern | ELowerPattern;
...
export declare function findDefinition(e: SyntaxNode | undefined | null, uri: string, elmWorkspace: IElmWorkspace): {
    expr: Expression;
    uri: string;
} | undefined;
export {};
