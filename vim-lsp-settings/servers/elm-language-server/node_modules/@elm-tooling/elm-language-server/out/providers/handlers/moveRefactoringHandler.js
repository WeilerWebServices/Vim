...
class MoveRefactoringHandler {
    constructor() {
        ...
        this.connection.onRequest(protocol_1.GetMoveDestinationRequest, new elmWorkspaceMatcher_1.ElmWorkspaceMatcher((param) => vscode_uri_1.URI.parse(param.sourceUri)).handlerForWorkspace(this.handleGetMoveDestinationsRequest.bind(this)));
        this.connection.onRequest(protocol_1.MoveRequest, new elmWorkspaceMatcher_1.ElmWorkspaceMatcher((param) => vscode_uri_1.URI.parse(param.sourceUri)).handlerForWorkspace(this.handleMoveRequest.bind(this)));
    }
