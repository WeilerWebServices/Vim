...
class SelectionRangeProvider {
    constructor() {
        this.handleSelectionRangeRequest = (params, elmWorkspace) => {
        ...
        this.connection.onSelectionRanges(new elmWorkspaceMatcher_1.ElmWorkspaceMatcher((param) => vscode_uri_1.URI.parse(param.textDocument.uri)).handlerForWorkspace(this.handleSelectionRangeRequest));
    }
