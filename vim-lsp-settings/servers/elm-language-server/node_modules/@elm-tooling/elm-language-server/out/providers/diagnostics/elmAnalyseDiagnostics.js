...
exports.ElmAnalyseDiagnostics = exports.CODE_ACTION_ELM_ANALYSE_FIX_ALL = exports.CODE_ACTION_ELM_ANALYSE = void 0;
...
const documentFormatingProvider_1 = require("../documentFormatingProvider");
...
let ElmAnalyseDiagnostics = class ElmAnalyseDiagnostics {
    constructor() {
        ...
        this.formattingProvider = tsyringe_1.container.resolve(documentFormatingProvider_1.DocumentFormattingProvider);
    ...
    updateFile(uri, text) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!analyser) {
                throw new Error(`No elm-analyse instance loaded for workspace ${uri.fsPath}.`);
            }
            yield analyser.then((elmAnalyser) => {
...
ElmAnalyseDiagnostics = __decorate([
