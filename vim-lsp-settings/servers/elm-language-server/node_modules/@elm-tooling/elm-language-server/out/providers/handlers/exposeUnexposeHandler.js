...
class ExposeUnexposeHandler {
    constructor() {
        ...
        this.connection.onRequest(protocol_1.ExposeRequest, new elmWorkspaceMatcher_1.ElmWorkspaceMatcher((params) => vscode_uri_1.URI.parse(params.uri)).handlerForWorkspace(this.handleExposeRequest.bind(this)));
        this.connection.onRequest(protocol_1.UnexposeRequest, new elmWorkspaceMatcher_1.ElmWorkspaceMatcher((params) => vscode_uri_1.URI.parse(params.uri)).handlerForWorkspace(this.handleUnexposeRequest.bind(this)));
    }
